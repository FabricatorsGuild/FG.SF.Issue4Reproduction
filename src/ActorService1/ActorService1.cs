namespace ActorService1
{
    ...
    internal class ActorService1 : Actor, IActorService1
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> IActorService1.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task IActorService1.SetCountAsync(int count, CancellationToken cancellationToken)
        {
